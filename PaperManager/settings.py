"""
Django settings for PaperManager project.
...
ROOT_URLCONF = 'PaperManager.urls'
...
WSGI_APPLICATION = 'PaperManager.wsgi.application'
...
# Path to store uploaded media files
